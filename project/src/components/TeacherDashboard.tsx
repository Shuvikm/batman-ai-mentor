...
import { Calendar, Users, IndianRupee, Star, BookOpen, Clock, CheckCircle, AlertCircle } from 'lucide-react';
      ...
      <div className="bg-black/50 border-b border-green-500/30 p-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">Batman Teacher Dashboard</h1>
              <p className="text-gray-400 flex items-center">
                <BatmanLogo size="small" className="mr-2" />
                  ...
                  <div className="bg-gray-900/50 rounded-lg p-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <p className="text-white font-medium">{formatCurrency(user.hourlyRate || 0)}/hour</p>
                      </div>
                      <div>
                        <p className="text-gray-400 text-sm">Total Sessions</p>
                      ...
                      <div key={session._id} className="bg-gray-900/50 border border-gray-700 rounded-lg p-6">
                        <div className="flex justify-between items-start mb-4">
                          ...
                          <div className="text-right">
                            ...
                            <p className="text-green-400 font-semibold">{formatCurrency(session.amount)}</p>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          ...
                          <p className="text-white">{formatCurrency(user.hourlyRate || 0)}/hour</p>
                        </div>
                        <div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-gray-900/50 rounded-lg p-6">
                    ...
                    <p className="text-3xl font-bold text-green-400">{formatCurrency(stats.totalEarnings)}</p>
                  </div>
                  
                  <div className="bg-gray-900/50 rounded-lg p-6">
                    <h4 className="text-lg font-medium text-white mb-2">This Month</h4>
                    <p className="text-3xl font-bold text-blue-400">{formatCurrency(0)}</p>
                  </div>
                  
                  <div className="bg-gray-900/50 rounded-lg p-6">
                    <h4 className="text-lg font-medium text-white mb-2">Average per Session</h4>
                    <p className="text-3xl font-bold text-purple-400">
                      {formatCurrency(stats.completedSessions > 0 ? (stats.totalEarnings / stats.completedSessions) : 0)}
                    </p>
                  </div>
                </div>
